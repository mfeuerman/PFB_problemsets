...
if [ ! -e ./ecoli.ms22/merylIndex ] ; then
  /Users/admin/canu/Darwin-amd64/bin/meryl threads=4 memory=2 \
    greater-than 1 \
...
if [ ! -e ./ecoli.ms22.histogram ] ; then
  /Users/admin/canu/Darwin-amd64/bin/meryl threads=1 memory=1 \
...
if [ ! -e ./ecoli.ms22.ignore.gz ] ; then
  ...
  totKmers=`/Users/admin/canu/Darwin-amd64/bin/meryl statistics ./ecoli.ms22 | grep present | awk '{ print $2 }'`
